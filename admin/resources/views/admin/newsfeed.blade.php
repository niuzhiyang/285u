...
<script type="text/javascript" src="admins/js/plugins/jquery.autogrow-textarea.js"></script>
<script type="text/javascript" src="admins/js/plugins/jquery.colorbox-min.js"></script>
...
<script type="text/javascript" src="admins/js/custom/newsfeed.js"></script>
<!--[if IE 9]>
    ...
    <div class="centercontent">
        ...
        <div class="contentwrapper">
        	...
        	<div class="two_third newsfeed">
                ...
                <div id="status" class="subcontent">
                    ...
                    <div class="statusbox">
                        <form id="poststatus" action="ajax/newsfeed/status.php" method="post">
                            <div class="status_thumb"><img src="../../admins/images/thumbs/avatarbig.png" alt="" width="57" /></div>
                ...
                <ul class="updatelist">
                	<li>
                    	<div class="updatethumb"><img src="admins/images/thumbs/avatar1.png" alt="" /></div>
                    ...
                    <li>
                    	<div class="updatethumb"><img src="admins/images/thumbs/avatar2.png" alt="" /></div>
                        <div class="updatecontent">
                        	<div class="top">
                            ...
                            <div class="photo">
                            	<a href="http://demo.themepixels.com/webpage/amanda/ajax/newsfeed/photo"><img src="admins/images/preview/preview1.png" alt="" /></a>
                            </div><!--text-->
                        </div><!--updatecontent-->
                    </li>
                    
                    <li>
                    	<div class="updatethumb"><img src="admins/images/thumbs/avatar3.png" alt="" /></div>
                        <div class="updatecontent">
                        	<div class="top">
                            ...
                            <div class="photo">
                            	<a href="http://demo.themepixels.com/webpage/amanda/ajax/newsfeed/photo2"><img src="admins/images/preview/preview2.png" alt="" /></a>
                            </div><!--text-->
                        </div><!--updatecontent-->
                    </li>
                    
                	<li>
                    	<div class="updatethumb"><img src="admins/images/thumbs/avatar4.png" alt="" /></div>
                        <div class="updatecontent">
                        	<div class="top">
                            	<a href="" class="user">Agnes</a> - <a href="">0 Comment</a> - 
                                <a href="">Share</a> - <a href="">Report</a> - <span>7 minutes ago</span>
