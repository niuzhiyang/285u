<div class="topheader">
        ...
        <div class="right">
            ...
            <div class="userinfodrop">
                ...
                <div class="userdata">
                    ...
                    <ul>
                    	<li><a href="editprofile">编辑资料</a></li>
                        <li><a href="accountsettings">账号设置</a></li>
    ...
    <div class="header">
    	<ul class="headermenu">
        	<li class="current"><a href="index"><span class="icon icon-flatscreen"></span>首页</a></li>
            <li><a href="manageblog"><span class="icon icon-pencil"></span>博客管理</a></li>
