...
<script type="text/javascript" src="admins/js/plugins/jquery.flot.min.js"></script>
<script type="text/javascript" src="admins/js/plugins/jquery.flot.resize.min.js"></script>
...
<script type="text/javascript" src="admins/js/custom/dashboard.js"></script>
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="admins/js/plugins/excanvas.min.js"></script><![endif]-->
<!--[if IE 9]>
                    ...
                    <div class="one_third last dashboard_right">
						...
						<div class="widgetbox">
                            ...
                            <div class="widgetcontent userlistwidget nopadding">
                                <ul>
                                    <li>
                                        <div class="avatar"><img alt="" src="admins/images/thumbs/avatar1.png" /></div>
                                        <div class="info">
                                            <a href="">Squint</a> <br />
                                    ...
                                    <li>
                                        <div class="avatar"><img alt="" src="admins/images/thumbs/avatar2.png" /></div>
                                        <div class="info">
                                            <a href="">Eunice</a> <br />
