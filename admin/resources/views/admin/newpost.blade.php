...
jQuery(document).ready(function(){
	...
	script_url : 'admins/js/plugins/tinymce/tiny_mce.js',
	...
	content_css : "admins/css/plugins/tinymce.css",
...
<div class="bodywrapper">
    ...
    <div class="vernav">
    	<ul>
        	<li><a href="manageblog">Posts</a></li>
            <li class="current"><a href="newpost">Create New Post</a></li>
