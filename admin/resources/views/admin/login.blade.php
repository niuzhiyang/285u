...
<script type="text/javascript" src="admins/js/custom/index.js"></script>
<!--[if IE 9]>
	...
	<div class="loginbox">
    	<div class="loginboxinner">
            ...
            <div class="nopassword">
				<div class="loginmsg">密码不正确.</div>
                <div class="loginf">
                    <div class="thumb"><img alt="" src="admins/images/thumbs/avatar1.png" /></div>
                    <div class="userlogged">
                        <h4></h4>
                        <a href="index">Not <span></span>?</a> 
                    </div>
                </div><!--loginf-->
            </div><!--nopassword-->
