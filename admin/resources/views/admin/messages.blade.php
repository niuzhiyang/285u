...
<script type="text/javascript" src="admins/js/custom/messages.js"></script>
<!--[if IE 9]>
...
<div class="bodywrapper">
    ...
    <div class="vernav iconmenu">
    	<ul>
        	<li class="current"><a href="manageblog" class="inbox">Inbox</a></li>
            <li><a href="newpost" class="drafts">Drafts</a></li>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable mailinbox">
                    ...
                    <tbody>
                        <tr class="unread">
                            ...
                            <td class="attachment"><img src="admins/images/icons/attachment.png" alt="" /></td>
