    ...
    script.src = src;
		...
		<div class="register_box" style="height: 365px;">
			...
			<div class="register_msg">
				...
				<input type="hidden" name="back_act" value="http://www.scstnysc.com/themes/hd/js/jquery.alerts.js" />
				...
				<tr>
					...
					<img class="fl pointer" id="captchaImg" src="other/other/other/other/other/other/captcha.php?236679709" style="vertical-align: middle;cursor: pointer; margin:0 0 0 4px; width:92px;margin-left: 5px;" onClick="this.src='captcha.php?'+Math.random()"/></td>
...
$.ajax({
    url:"stat.php",
    type: "post",
    data:'act=visit&visit_times=49&lang=&domain=&path=&access_url=/user.php?act=register&back_act=http://www.scstnysc.com/themes/hd/js/jquery.alerts.js&access_domain=http://www.scstnysc.com&time=1458304720&session_id=1cd1be091774628f649f2140fa402908&user_id=0&goods_id=0&is_mobile=0',
    async:true
});
</script>
