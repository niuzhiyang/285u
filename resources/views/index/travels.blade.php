...
$.ajax({
    url:"stat.php",
    type: "post",
    data:'act=visit&visit_times=80&lang=&domain=&path=&access_url=/article_cat.php?id=21&access_domain=http://www.scstnysc.com&time=1458306637&session_id=1cd1be091774628f649f2140fa402908&user_id=0&goods_id=0&is_mobile=0',
    async:true
});
</script>
</body>
